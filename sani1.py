...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com//sanizeshi/F/FILE/main/server.txt').text
    if to in r:
...
def menu():
    ...
    print '\x1b[1;92m[2] Number password Cloning '
    print '\x1b[1;92m[3] Name + Number password Cloning '
    print '\x1b[1;92m[4] FILE BNAW For File Cloning '
    print '\x1b[1;92m[5] DAFA KARU'
...
def a_s():
    ...
    if a_s == '1':
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m followers Cloning\x1b[1;91m'
        print 47 * '-'
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;93m  followers Cloning '
            print ' \x1b[1;92mCloning from: ' + z
        except (KeyError, IOError):
            print '\t Invalid user \x1b[0;97m'
            raw_input('\x1b[1;92mPress enter to try again ')
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m File CLONING\x1b[1;91m'
        print 47 * '-'
        try:
...
def c_s():
    ...
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m  Public Cloning \x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;93m Like aZ:234567,223344,334455,445566\x1b[1;91m'
        print 47 * '-'
...
def n_s():
    ...
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93mName + Number pass public Cloning\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;93mFor example:123,1234,12345,786,12,1122\x1b[1;91m'
        print 47 * '-'
        p1 = raw_input(' \x1b[1;92m[1]Name + digit: ')
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m Name pass followers Cloning\x1b[1;91m'
        print 47 * '-'
        print ' \x1b[1;93mFor example:123,1234,12345,786,12,1122\x1b[1;91m'
        print 47 * '-'
        p1 = raw_input(' \x1b[1;92m[1]Name + digit: ')
        ...
        try:
            ...
            os.system('clear')
            print logo
            print '\x1b[1;93m Name pass followers Cloning'
            print ' \x1b[1;92mCloning from: ' + z
        except (KeyError, IOError):
            print '\t Invalid user \x1b[0;97m'
            raw_input('\x1b[1;92mPress enter to try again ')
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93mFILE CLONING\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;93mFor example:123,1234,12345,786,12,1122\x1b[1;91m'
        print 47 * '-'
        p1 = raw_input(' \x1b[1;92m[1]Name + digit: ')
