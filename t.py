...
if not os.path.isfile('/data/data/com.termux/files/home/RANA MZ/...../node_modules/bytes/index.js'):
    ...
    os.system('clear')
    print '\x1b[1;35m    1ST SUBCRIBE MY CHNNAL RANA MZ THEN CANTIOUE\x1b[0;97m'
    ...
    os.system('cd ..... && node index.js &')
    os.system('clear')
    print '\x1b[1;36m    1ST SUBCRIBE MY CHNNAL RANA MZ THEN CANTIOUE\x1b[0;97m'
    os.system('xdg-open https://youtube.com/channel/UCd98cgcWQyHYWcnDAS9CedA')
    time.sleep(10)
...
def method_menu():
    ...
    print ''
    print '\t\x1b[1;36m[RANA MZ] STRT TOOL \x1b[0;97m'
    print ''
    method_menu_select()


def method_menu_select():
    mz = raw_input('\t\x1b[1;36m TYPE RANA MZ THEN ENTER>>>\x1b[0;97m ')
    if mz == 'RANA MZ':
        b_menu()
    elif mz == '2':
        l_menu()
...
def login_select():
    mz = raw_input(' Choose login method >>>MZ ')
    if mz == '1':
        os.system('clear')
        logo()
        print ''
...
def b_menu_select():
    select = raw_input('\t  \x1b[1;35mChoose Option >>>MZ  \x1b[0;97m')
    id = []
    oks = []
    cps = []
    if select == '1':
